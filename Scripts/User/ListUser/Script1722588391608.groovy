...
// You can also verify if the users are returned in the list
// Verify JSON element properties for the first item in the data array
...
// Verify JSON element properties for the second object
...
// Continue with other objects as needed
